@echo off
rem launch_yeetingus.bat — start YEETingus with a clean Python environment.
rem
...
rem whole reason this shim exists — do not launch YEETingus.exe directly from Resolve.
set "PYTHONHOME="
set "PYTHONPATH="
set "PYTHONSTARTUP="
